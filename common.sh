...
DEBIAN_PORTS_BUILDS="riscv64"
DEBIAN_BUILDS="$DEBIAN_BUSTER_BUILDS $DEBIAN_STRETCH_BUILDS $DEBIAN_JESSIE_BUILDS $DEBIAN_SQUEEZE_BUILDS $DEBIAN_PORTS_BUILDS"
...
BUILD_ENV_riscv64="debian-riscv64"
